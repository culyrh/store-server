...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "사용자 생성 요청 (관리자용)")
public class CreateUserRequest {

    @Schema(description = "이메일", example = "admin@example.com", required = true)
    ...
    @Schema(description = "이름", example = "관리자", required = true)
    ...
    @Schema(description = "권한", example = "USER", required = true)
